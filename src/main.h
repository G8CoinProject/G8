...
// Copyright (c) 2013-2014 G8coin developers
...
static const unsigned int MAX_TX_COMMENT_LEN_V1 = 140; // G8coin: 128 bytes + little extra
...
static const int64 MAX_MONEY = 101000000 * COIN; 
