...
uint256 hashGenesisBlock("0xd57ea7971ad14fc31925c1548d501ab67a5f124724b192ecab9d3fc0a35e87a3");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // G8coin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "G8coin Signed Message:\n";
...
{
    int64 nSubsidy = .0001 * COIN; 
    if(nHeight < 11)  {nSubsidy = 10000000 * COIN;}
...
static const int64 nTargetTimespan_Version1 = 60 * 60; 
static const int64 nInterval_Version1 = nTargetTimespan_Version1 / nTargetSpacing; // G8coin: 90 blocks

static const int64 nHeight_Version2 = 5000000;
...
static const int64 nHeight_Version3 = 10000000;
...
static const int64 nMaxAdjustDown_Version1 = 30; 
static const int64 nMaxAdjustUp_Version1 = 30; 
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
        ...
        if (fTestNet) {
                ...
                if (pindexLast->nHeight+1 >= 2050) { DiffMode = 2; }
        }
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal g8coin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "G8coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
		...
		//   CTransaction(hash=730f0c8ddc, ver=2, vin.size=1, vout.size=1, nLockTime=0, strTxComment=text:G8coin genesis block)
        ...
        // Genesis block
        const char* pszTimestamp = "G 8 C O I N";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		txNew.strTxComment = "text:G8coin genesis block";
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1402852897;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2082228;
        ...
        assert(block.hashMerkleRoot == uint256("0x94ff6fda7c0f65061bea4254e3b9cee0322a8d0c7d82737d5e8b76aaeba96be0"));
...
//   0xa5, 0xf1 = unique id
unsigned char pchMessageStart[4] = { 0xc0, 0xc0, 0xa5, 0xa5 };
